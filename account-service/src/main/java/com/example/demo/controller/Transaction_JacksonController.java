...
@RestController
@RequestMapping("/api/transactions_jackson")
public class Transaction_JacksonController {

    private final TransactionRepository repo;
    private final ObjectMapper objectMapper;

    public Transaction_JacksonController(TransactionRepository repo, ObjectMapper objectMapper) {
        this.repo = repo;
        this.objectMapper = objectMapper;
    }

    @PostMapping("/reserve")
    public ResponseEntity<String> reserve(@Valid @RequestBody String transactionJson) throws Exception {
        TransactionReserveRequest req = objectMapper.readValue(transactionJson, TransactionReserveRequest.class);
    ...
    public ResponseEntity<String> list() throws Exception {
        List<AcctTransaction> list = repo.findAll();
